	...
	<div class="wrapper">
        ...
        <style>
            .container {
              ...
              border-radius: 8px;
              box-shadow: 0 4px 12px rgb(255, 161, 161);
            }
        
            /* Tabla de detalles en el footer */
            ...
            .footer-details-table td:first-child {
                width: 50%;
            }
        
            .footer-details-table td:last-child {
                text-align: right;
            }
        
            /* Estilo separado para las celdas de Descuentos e IGV */
            .footer-details-table .separator-row {
          ...
          <div class="container mt-5">
            ...
            <!-- Información de la empresa y datos de la boleta -->
            <div class="header">
              <!-- Empresa y logo -->
              <div class="logo">
                <img src="assets/images/logotipo.png" alt="Logo" class="img-fluid">
                <p><strong>Botica San Antonio</strong></p>
              </div>
          
              <!-- Información de la boleta (RUC, Fecha, Hora) alineados a la derecha -->
              <div class="right-info">
                <p><strong>RUC:</strong> 10435605856</p>
            ...
            <div class="details mb-3">
              <p><span class="font-weight-bold">Cliente:</span> <span id="cliente"></span></p>
              <p><span class="font-weight-bold">DNI:</span> <span id="dni"></span></p>
            </div>
            ...
            <div class="footer text-center">
                <!-- Tabla con detalles de pago y descuentos -->
                <table class="footer-details-table">
                    <tr>
                        <td><strong>Forma de Pago:</strong> Efectivo</td>
            ...
            <div class="total text-right">
                <p><strong>Total (S/):</strong> <span id="total"></span></p>
            </div>
            
            <!-- Mensaje de recogida -->
            <p><strong>Recuerde acercarse a la botica a recoger los productos con esta boleta</strong></p>
